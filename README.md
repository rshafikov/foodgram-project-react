...
![Django-app workflow](https://github.com/rshafikov/foodgram-project-react/actions/workflows/main.yml/badge.svg)

### Доступ
Проект развернут на [сервере](http://62.84.121.169)

Доступ в [админку](http://62.84.121.169/admin/) `admin admin`
...
```
git clone https://github.com/rshafikov/foodgram-project-react.git
cd backend
```
...
- ```api/docs/``` - Подробная документация по работе API.
